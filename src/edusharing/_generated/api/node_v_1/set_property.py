...
def _get_kwargs(
    ...
    *,
    ...
    property_: str,
    keep_modified_date: bool | Unset = False,
) -> dict[str, Any]:
    ...
    params["keepModifiedDate"] = keep_modified_date

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/node/v1/nodes/{repository}/{node}/property".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        node (str):
        property_ (str):
        keep_modified_date (bool | Unset):  Default: False.
        body (list[str] | Unset):
