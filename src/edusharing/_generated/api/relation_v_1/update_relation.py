...
from ...models.update_relation_request import UpdateRelationRequest
...
def _get_kwargs(
    repository: str,
    *,
    body: UpdateRelationRequest | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """update relation metadata between nodes

     Updates relation metadata between two nodes of the given type.

    Args:
        repository (str):
        body (UpdateRelationRequest | Unset):
