...
def _get_kwargs(
    *,
    body: CreateApplicationBody | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """register/add an application via xml file
     ...
     register the xml file provided. Fails if the application is already registered, use PUT to update or
    insert.

    Args:
        body (CreateApplicationBody | Unset):
