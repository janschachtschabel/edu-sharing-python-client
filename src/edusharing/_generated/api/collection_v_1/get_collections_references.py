...
from ...models.reference_entries import ReferenceEntries
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/collection/v1/collections/{repository}/{collection}/children/references".format(
...
) -> ErrorResponse | ReferenceEntries | None:
    if response.status_code == 200:
        response_200 = ReferenceEntries.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | ReferenceEntries]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | ReferenceEntries
    """
