...
from ...models.collection_proposal_entries import CollectionProposalEntries
from ...models.error_response import ErrorResponse
from ...models.get_collections_containing_proposals_status import (
...
def _get_kwargs(
    repository: str,
    *,
    status: GetCollectionsContainingProposalsStatus
    | Unset = GetCollectionsContainingProposalsStatus.PENDING,
    fetch_counts: bool | Unset = True,
    max_items: int | Unset = 50,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/collection/v1/collections/{repository}/children/proposals/collections".format(
...
) -> CollectionProposalEntries | ErrorResponse | None:
    if response.status_code == 200:
        response_200 = CollectionProposalEntries.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CollectionProposalEntries | ErrorResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        repository (str):
        status (GetCollectionsContainingProposalsStatus | Unset):  Default:
            GetCollectionsContainingProposalsStatus.PENDING.
        fetch_counts (bool | Unset):  Default: True.
        max_items (int | Unset):  Default: 50.
...
def sync(
    ...
    *,
    ...
    Returns:
        CollectionProposalEntries | ErrorResponse
    """
