...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/iam/v1/people/{repository}/{person}/credential/2fa/activate".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Activate two factor authentication for user
     ...
     Activate two factor authentication for user (To activate foreign 2fa method, admin rights are
    required.)

    Args:
        repository (str):
        person (str):
        x_2fa_token (int | Unset):
