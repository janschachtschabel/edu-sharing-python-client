...
from ...models.update_user_status_status import UpdateUserStatusStatus
...
def _get_kwargs(
    ...
    *,
    ...
    if any(str(value) in ("", ".", "..") for value in (repository, person, status,)):
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/iam/v1/people/{repository}/{person}/status/{status}".format(
