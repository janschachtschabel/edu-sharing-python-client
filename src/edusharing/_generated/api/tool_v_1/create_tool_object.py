...
from ...models.create_tool_object_body import CreateToolObjectBody
...
def _get_kwargs(
    ...
    toolinstance: str,
    *,
    body: CreateToolObjectBody,
    rename_if_exists: bool | Unset = False,
    version_comment: str | Unset = UNSET,
) -> dict[str, Any]:
    if any(str(value) in ("", ".", "..") for value in (repository, toolinstance,)):
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/tool/v1/tools/{repository}/{toolinstance}/toolobject".format(
            repository=quote(str(repository), safe=""),
            toolinstance=quote(str(toolinstance), safe=""),
        ),
        "params": params,
    }
