...
from ...models.search_content_type import SearchContentType
...
def _get_kwargs(
    ...
    *,
    ...
    content_type: SearchContentType | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/search/v1/queries/{repository}/{metadataset}/{query}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        metadataset (str):
        query (str):
        content_type (SearchContentType | Unset):
