...
from ...models.search_1_body import Search1Body
from ...models.stream_list import StreamList
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/stream/v1/search/{repository}".format(
...
) -> ErrorResponse | StreamList | None:
    if response.status_code == 200:
        response_200 = StreamList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | StreamList]:
    return Response(
