...
def _get_kwargs(
    ...
    if any(str(value) in ("", ".", "..") for value in (repository, mediacenter, group,)):
...
def sync_detailed(
    ...
    *,
    ...
    """add a group that is managed by the given mediacenter
     ...
     although not restricted, it is recommended that the group is an edu-sharing organization (admin
    rights are required)
