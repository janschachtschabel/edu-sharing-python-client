...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/lti/v13/details/{repository}/{node}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """get a html snippet containing a rendered version of a node. this method can be called from a
    platform as a xhr request instead of doing the resource link flow
