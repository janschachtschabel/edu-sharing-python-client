...
def _get_kwargs(
    *,
    ...
    params["authentication_request_url"] = authentication_request_url

    params["keyset_url"] = keyset_url

    params["key_id"] = key_id

    params["auth_token_url"] = auth_token_url

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/lti/v13/registration/static",
        "params": params,
    }
