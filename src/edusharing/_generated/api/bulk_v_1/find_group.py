...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/bulk/v1/find/group/{group}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """gets a given root folder for a group id

     Get a given root folder (crawler folder). Might be used to do bulk operations like global
    invitations
