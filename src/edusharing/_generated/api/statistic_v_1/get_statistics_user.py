...
from ...models.get_statistics_user_body import GetStatisticsUserBody
from ...models.get_statistics_user_grouping import GetStatisticsUserGrouping
...
def _get_kwargs(
    *,
    body: GetStatisticsUserBody | Unset = UNSET,
    grouping: GetStatisticsUserGrouping,
    date_from: int,
    date_to: int,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/statistic/v1/statistics/users",
        "params": params,
    }
...
) -> ErrorResponse | list[Tracking] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | list[Tracking]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """get statistics for user actions (login, logout)
     ...
     requires either toolpermission TOOLPERMISSION_GLOBAL_STATISTICS_USER for global stats or to be admin
    ...
    Args:
        ...
        body (GetStatisticsUserBody | Unset):
