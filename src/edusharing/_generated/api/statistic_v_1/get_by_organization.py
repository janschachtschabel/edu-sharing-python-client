...
from ...models.get_by_organization_content_type import GetByOrganizationContentType
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/statistic/v1/statistics/nodes/organization/{org_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """get statistics for node actions for the given organization.
    ...
    Args:
        ...
        content_type (GetByOrganizationContentType | Unset):
