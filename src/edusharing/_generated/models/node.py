...
if TYPE_CHECKING:
    ...
    from ..models.node_relations import NodeRelations
...
class Node:
    ...
    Attributes:
        ...
        properties (NodeProperties | Unset): Properties of the node; Dynamic key value pairs depending on the properties
        ...
        relations (NodeRelations | Unset): Relations to other nodes
    ...
    properties: NodeProperties | Unset = UNSET
    ...
    relations: NodeRelations | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        properties: NodeProperties | Unset
        ...
        relations: NodeRelations | Unset
        if isinstance(_relations, Unset):
            relations = UNSET
        else:
            relations = NodeRelations.from_dict(_relations)
