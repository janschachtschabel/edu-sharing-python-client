...
T = TypeVar("T", bound="CollectionProposalEntries")
...
class CollectionProposalEntries:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for collections_item_data in _collections:
            collections_item = NodeCollectionProposalCount.from_dict(collections_item_data)
        ...
        collection_proposal_entries = cls(
            collections=collections,
            pagination=pagination,
        )

        collection_proposal_entries.additional_properties = d
        return collection_proposal_entries
