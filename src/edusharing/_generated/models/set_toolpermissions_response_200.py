...
T = TypeVar("T", bound="SetToolpermissionsResponse200")


@_attrs_define
class SetToolpermissionsResponse200:
    """ """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        set_toolpermissions_response_200 = cls()
        ...
        set_toolpermissions_response_200.additional_properties = additional_properties
        return set_toolpermissions_response_200
