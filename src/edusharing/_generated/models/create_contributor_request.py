...
from ..models.create_contributor_request_kind import CreateContributorRequestKind
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateContributorRequest")
...
class CreateContributorRequest:
    """
    Attributes:
        kind (CreateContributorRequestKind | Unset):
        title (str | Unset):
        givenname (str | Unset):
        surname (str | Unset):
        org (str | Unset):
    ...
    kind: CreateContributorRequestKind | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if isinstance(_kind, Unset):
            ...
            kind = CreateContributorRequestKind(_kind)
        ...
        create_contributor_request = cls(
            kind=kind,
            title=title,
            givenname=givenname,
            surname=surname,
        ...
        create_contributor_request.additional_properties = d
        return create_contributor_request
