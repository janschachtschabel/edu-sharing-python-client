...
T = TypeVar("T", bound="CollectionEntries")
...
class CollectionEntries:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for collections_item_data in _collections:
            collections_item = Node.from_dict(collections_item_data)
        ...
        collection_entries = cls(
            collections=collections,
            pagination=pagination,
        )

        collection_entries.additional_properties = d
