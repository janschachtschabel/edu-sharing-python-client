...
T = TypeVar("T", bound="MultivaluedMapStringParameterizedHeader")


@_attrs_define
class MultivaluedMapStringParameterizedHeader:
    """
    Attributes:
        empty (bool | Unset):
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        multivalued_map_string_parameterized_header = cls(
            empty=empty,
        )
        ...
        multivalued_map_string_parameterized_header.additional_properties = additional_properties
        return multivalued_map_string_parameterized_header
