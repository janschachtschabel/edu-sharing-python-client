...
T = TypeVar("T", bound="SearchResultEvent")
...
class SearchResultEvent:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for nodes_item_data in _nodes:
            nodes_item = UserEvent.from_dict(nodes_item_data)
        ...
        search_result_event.additional_properties = d
        return search_result_event
