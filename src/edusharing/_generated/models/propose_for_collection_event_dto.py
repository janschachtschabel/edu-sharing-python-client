...
T = TypeVar("T", bound="ProposeForCollectionEventDTO")


@_attrs_define
class ProposeForCollectionEventDTO:
    """
    Attributes:
        field_class_ (str):
        ...
        collection (CollectionDTO | Unset):
    """
    ...
    collection: CollectionDTO | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if isinstance(_collection, Unset):
            ...
            collection = CollectionDTO.from_dict(_collection)

        propose_for_collection_event_dto = cls(
        ...
        propose_for_collection_event_dto.additional_properties = d
        return propose_for_collection_event_dto
