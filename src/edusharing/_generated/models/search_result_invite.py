...
if TYPE_CHECKING:
    ...
    from ..models.invite_event import InviteEvent
    from ..models.pagination import Pagination
    from ..models.suggest import Suggest


T = TypeVar("T", bound="SearchResultInvite")


@_attrs_define
class SearchResultInvite:
    """
    Attributes:
        nodes (list[InviteEvent]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for nodes_item_data in _nodes:
            nodes_item = InviteEvent.from_dict(nodes_item_data)
        ...
        search_result_invite.additional_properties = d
        return search_result_invite
