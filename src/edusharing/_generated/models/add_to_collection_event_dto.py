...
T = TypeVar("T", bound="AddToCollectionEventDTO")


@_attrs_define
class AddToCollectionEventDTO:
    """
    Attributes:
        field_class_ (str):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        add_to_collection_event_dto = cls(
        ...
        add_to_collection_event_dto.additional_properties = d
        return add_to_collection_event_dto
