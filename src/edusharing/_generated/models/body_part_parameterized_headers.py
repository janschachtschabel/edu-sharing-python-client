...
T = TypeVar("T", bound="BodyPartParameterizedHeaders")
...
class BodyPartParameterizedHeaders:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        body_part_parameterized_headers = cls(
            empty=empty,
        )
        ...
        body_part_parameterized_headers.additional_properties = additional_properties
        return body_part_parameterized_headers
