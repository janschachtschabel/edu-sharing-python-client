...
T = TypeVar("T", bound="FormDataBodyPartParameterizedHeaders")


@_attrs_define
class FormDataBodyPartParameterizedHeaders:
    """
    Attributes:
        empty (bool | Unset):
    """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        form_data_body_part_parameterized_headers = cls(
            empty=empty,
        )
        ...
        form_data_body_part_parameterized_headers.additional_properties = additional_properties
        return form_data_body_part_parameterized_headers
