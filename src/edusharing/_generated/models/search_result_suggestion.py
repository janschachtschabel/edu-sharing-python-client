...
if TYPE_CHECKING:
    ...
    from ..models.node_suggestion_entry import NodeSuggestionEntry
    from ..models.pagination import Pagination
    from ..models.suggest import Suggest


T = TypeVar("T", bound="SearchResultSuggestion")


@_attrs_define
class SearchResultSuggestion:
    """
    Attributes:
        nodes (list[NodeSuggestionEntry]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for nodes_item_data in _nodes:
            nodes_item = NodeSuggestionEntry.from_dict(nodes_item_data)
        ...
        search_result_suggestion.additional_properties = d
        return search_result_suggestion
