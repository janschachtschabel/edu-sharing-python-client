...
class JobDataMap:
    ...
    Attributes:
        ...
        keys (list[str] | Unset):
        wrapped_map (JobDataMapWrappedMap | Unset):
        empty (bool | Unset):
    """
    ...
    wrapped_map: JobDataMapWrappedMap | Unset = UNSET
    empty: bool | Unset = UNSET
    additional_properties: dict[str, JobDataMapAdditionalProperty] = _attrs_field(
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if isinstance(_wrapped_map, Unset):
            ...
            wrapped_map = JobDataMapWrappedMap.from_dict(_wrapped_map)
        ...
        for prop_name, prop_dict in d.items():
            additional_property = JobDataMapAdditionalProperty.from_dict(prop_dict)

            additional_properties[prop_name] = additional_property

        job_data_map.additional_properties = additional_properties
        return job_data_map
    ...
    def __getitem__(self, key: str) -> JobDataMapAdditionalProperty:
        return self.additional_properties[key]

    def __setitem__(self, key: str, value: JobDataMapAdditionalProperty) -> None:
