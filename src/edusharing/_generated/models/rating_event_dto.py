...
T = TypeVar("T", bound="RatingEventDTO")
...
class RatingEventDTO:
    ...
    Attributes:
        ...
        new_rating (float | Unset):
        rating_sum (float | Unset):
    ...
    new_rating: float | Unset = UNSET
    rating_sum: float | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if new_rating is not UNSET:
            field_dict["newRating"] = new_rating
        if rating_sum is not UNSET:
            field_dict["ratingSum"] = rating_sum
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        new_rating = d.pop("newRating", UNSET)

        rating_sum = d.pop("ratingSum", UNSET)

        rating_count = d.pop("ratingCount", UNSET)

        rating_event_dto = cls(
        ...
        rating_event_dto.additional_properties = d
        return rating_event_dto
