...
T = TypeVar("T", bound="MultivaluedMapStringString")
...
class MultivaluedMapStringString:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        multivalued_map_string_string = cls(
            empty=empty,
        )
        ...
        multivalued_map_string_string.additional_properties = additional_properties
        return multivalued_map_string_string
