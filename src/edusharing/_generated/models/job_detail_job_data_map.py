...
T = TypeVar("T", bound="JobDetailJobDataMap")


@_attrs_define
class JobDetailJobDataMap:
    """
    Attributes:
        dirty (bool | Unset):
        allows_transient_data (bool | Unset):
        keys (list[str] | Unset):
        wrapped_map (JobDetailJobDataMapWrappedMap | Unset):
        empty (bool | Unset):
    """
    ...
    wrapped_map: JobDetailJobDataMapWrappedMap | Unset = UNSET
    empty: bool | Unset = UNSET
    additional_properties: dict[str, JobDetailJobDataMapAdditionalProperty] = _attrs_field(
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if isinstance(_wrapped_map, Unset):
            ...
            wrapped_map = JobDetailJobDataMapWrappedMap.from_dict(_wrapped_map)

        empty = d.pop("empty", UNSET)

        job_detail_job_data_map = cls(
            dirty=dirty,
        ...
        for prop_name, prop_dict in d.items():
            additional_property = JobDetailJobDataMapAdditionalProperty.from_dict(prop_dict)

            additional_properties[prop_name] = additional_property

        job_detail_job_data_map.additional_properties = additional_properties
        return job_detail_job_data_map

    @property
    def additional_keys(self) -> list[str]:
        return list(self.additional_properties.keys())

    def __getitem__(self, key: str) -> JobDetailJobDataMapAdditionalProperty:
        return self.additional_properties[key]

    def __setitem__(self, key: str, value: JobDetailJobDataMapAdditionalProperty) -> None:
