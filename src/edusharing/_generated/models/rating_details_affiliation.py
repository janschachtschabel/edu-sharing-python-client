...
T = TypeVar("T", bound="RatingDetailsAffiliation")


@_attrs_define
class RatingDetailsAffiliation:
    """ """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        rating_details_affiliation = cls()
        ...
        rating_details_affiliation.additional_properties = additional_properties
        return rating_details_affiliation
