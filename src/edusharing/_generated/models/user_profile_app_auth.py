...
if TYPE_CHECKING:
    from ..models.user_profile_app_auth_extended_attributes import (
        UserProfileAppAuthExtendedAttributes,
    )


T = TypeVar("T", bound="UserProfileAppAuth")
...
class UserProfileAppAuth:
    ...
    Attributes:
        ...
        extended_attributes (UserProfileAppAuthExtendedAttributes | Unset):
        vcard (str | Unset):
    """
    ...
    extended_attributes: UserProfileAppAuthExtendedAttributes | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        extended_attributes: dict[str, Any] | Unset = UNSET
        if not isinstance(self.extended_attributes, Unset):
            extended_attributes = self.extended_attributes.to_dict()
        ...
        if extended_attributes is not UNSET:
            field_dict["extendedAttributes"] = extended_attributes
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        _extended_attributes = d.pop("extendedAttributes", UNSET)
        extended_attributes: UserProfileAppAuthExtendedAttributes | Unset
        if isinstance(_extended_attributes, Unset):
            extended_attributes = UNSET
        else:
            extended_attributes = UserProfileAppAuthExtendedAttributes.from_dict(
                _extended_attributes
            )

        vcard = d.pop("vcard", UNSET)

        user_profile_app_auth = cls(
        ...
        user_profile_app_auth.additional_properties = d
        return user_profile_app_auth
